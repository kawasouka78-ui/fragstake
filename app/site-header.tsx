...
export default function SiteHeader(){
 ...
 return <>
  ...
  <header className="arena-topbar"><div className="topbar-context"><Crosshair size={16}/><span>SKILLCLASH</span><ChevronRight size={13}/><b>{current}</b></div><div className="topbar-actions"><details className="mobile-utility-menu"><summary className="mobile-settings icon-button" aria-label="More pages"><Menu size={18}/></summary><nav aria-label="More pages"><a href="/profile">Your profile</a><a href="/inventory">Your inventory</a><a href="/ranked">Rankings</a><a href="/settings">Settings</a><a href="/support">Help & support</a></nav></details><a className="topbar-balance" href="/wallet"><Wallet size={17}/><span><small>DEMO BALANCE</small><b>{data?euro(data.player.balance):'—'}</b></span><i aria-hidden="true"><Plus size={16}/></i></a></div></header>
 </>;
}
