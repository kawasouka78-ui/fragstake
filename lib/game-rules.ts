...
export type Result = { kills:number; deaths:number; balance:number; reason:string; won:boolean; score:number; enemyScore:number;headshots?:number;maxStreak?:number };
