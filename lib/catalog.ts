export const catalog=[
 ...
 {sku:'carbon-weave',name:'Carbon Weave',kind:'Weapon wrap',price:1799,color:'#74818b',pattern:'carbon',description:'Black carbon fibre with a tight diagonal weave and satin sheen.'},
 {sku:'urban-digital',name:'Urban Digital',kind:'Weapon wrap',price:1499,color:'#98aaa4',pattern:'digital',description:'Layered graphite, stone and sage pixel camouflage.'},
 {sku:'desert-ops',name:'Desert Ops',kind:'Weapon wrap',price:1499,color:'#d0ad76',pattern:'desert',description:'Sand, clay and dark earth camouflage with a matte field finish.'},
 {sku:'crimson-tiger',name:'Crimson Tiger',kind:'Weapon wrap',price:1999,color:'#d54252',pattern:'tiger',description:'Sharp black tiger stripes over deep crimson lacquer.'},
 {sku:'blue-porcelain',name:'Blue Porcelain',kind:'Weapon wrap',price:2499,color:'#a3c4ed',pattern:'porcelain',description:'Cobalt wave motifs on a smooth ivory ceramic shell.'},
 {sku:'copper-damascus',name:'Copper Damascus',kind:'Weapon wrap',price:2499,color:'#cc926e',pattern:'damascus',description:'Flowing copper and dark bronze layers in polished patterned steel.'},
 {sku:'alpine-contour',name:'Alpine Contour',kind:'Weapon wrap',price:1799,color:'#c1d7cf',pattern:'contour',description:'Fine topographic lines etched across pale alpine green.'},
 {sku:'hazard-stripe',name:'Hazard Stripe',kind:'Weapon wrap',price:1599,color:'#e8be46',pattern:'hazard',description:'Industrial yellow warning stripes with worn black edges.'},
...
export function cosmeticFinish(item:Cosmetic|undefined):string|undefined{return item?('effect' in item?'fx:'+item.effect:'pattern' in item?'wrap:'+item.pattern:item.color):undefined;}
